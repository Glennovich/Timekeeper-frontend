...
// a full solution for string manipulation and internationalization.
    ...
    $.extend(Datepicker.prototype, {
        ...
        _generateHTML: function (inst) {
            ...
            var nextIcon = "<svg width='30' height='35'><g><path id='previous' d='m 1,5 20,10 -20,10 z'/></g>/svg>"
            var prevIcon = "<svg width='30' height='35'><g><path id='previous' d='m 1,15 20,-10 0,20 z'/></g></svg>"

            prev = (this._canAdjustMonth(inst, -1, drawYear, drawMonth) ?
                    "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click'" +
                    " title='previous'>" + prevIcon + "</a>" :
                    (hideIfNoPrevNext ? "" : "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='previous'>" + prevIcon + "</a>"));
            ...
            next = (this._canAdjustMonth(inst, +1, drawYear, drawMonth) ?
                    ...
                    " title='next'>" + nextIcon + "</a>" :
                    (hideIfNoPrevNext ? "" : "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='next'>" + nextIcon + "</a>"));
